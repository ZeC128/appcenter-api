...
/**
 * LogFlowDevice Class Doc Comment
 *
 * @category Class
 ...
 * @link     https://github.com/swagger-api/swagger-codegen
 */
class LogFlowDevice implements ModelInterface, ArrayAccess
{
    ...
    /**
      ...
      * @var string
      */
    protected static $swaggerModelName = 'LogFlowDevice';
    ...
    public function setTimeZoneOffset($time_zone_offset)
    {
        ...
        if (($time_zone_offset > 840)) {
            throw new \InvalidArgumentException('invalid value for $time_zone_offset when calling LogFlowDevice., must be smaller than or equal to 840.');
        }
        if (($time_zone_offset < -840)) {
            throw new \InvalidArgumentException('invalid value for $time_zone_offset when calling LogFlowDevice., must be bigger than or equal to -840.');
        }
