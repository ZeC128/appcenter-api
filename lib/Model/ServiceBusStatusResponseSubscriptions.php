...
/**
 * ServiceBusStatusResponseSubscriptions Class Doc Comment
 *
 * @category Class
 * @package  Swagger\Client
 * @author   Swagger Codegen team
 * @link     https://github.com/swagger-api/swagger-codegen
 */
class ServiceBusStatusResponseSubscriptions implements ModelInterface, ArrayAccess
{
    ...
    /**
      ...
      * @var string
      */
    protected static $swaggerModelName = 'ServiceBusStatusResponse_subscriptions';
     ...
     * Sets name
     *
     * @param string $name The name of the subsciption (prefixed with the topic name)
     *
     * @return $this
     */
     ...
     * Sets message_count
     *
     * @param float $message_count The number of messages in the subscription
     *
     * @return $this
     */
