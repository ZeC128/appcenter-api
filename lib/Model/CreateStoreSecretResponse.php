...
/**
 * CreateStoreSecretResponse Class Doc Comment
 *
 * @category Class
 * @package  Swagger\Client
 * @author   Swagger Codegen team
 * @link     https://github.com/swagger-api/swagger-codegen
 */
class CreateStoreSecretResponse implements ModelInterface, ArrayAccess
{
    ...
    /**
      ...
      * @var string
      */
    protected static $swaggerModelName = 'CreateStoreSecretResponse';
     ...
     * Sets secret_id
     *
     * @param string $secret_id the secret id for store secret
     *
     * @return $this
     */
