...
/**
 * OrgDistributionGroupDetailsResponse Class Doc Comment
 *
 * @category Class
 * @package  Swagger\Client
 * @author   Swagger Codegen team
 * @link     https://github.com/swagger-api/swagger-codegen
 */
class OrgDistributionGroupDetailsResponse implements ModelInterface, ArrayAccess
{
    ...
    /**
      ...
      * @var string
      */
    protected static $swaggerModelName = 'OrgDistributionGroupDetailsResponse';
    ...
    protected static $setters = [
        ...
        'total_users_count' => 'setTotalUsersCount',
        'apps' => 'setApps'
    ];
    ...
    public function __construct(array $data = null)
    {
        ...
        $this->container['total_users_count'] = isset($data['total_users_count']) ? $data['total_users_count'] : null;
    ...
    /**
     * Gets total_users_count
     *
     * @return float
     */
    public function getTotalUsersCount()
    {
        return $this->container['total_users_count'];
    }

    /**
     * Sets total_users_count
     *
     * @param float $total_users_count The count of users in the distribution group
     *
     * @return $this
     */
    public function setTotalUsersCount($total_users_count)
    {
        $this->container['total_users_count'] = $total_users_count;
     ...
     * Sets apps
     *
     * @param object[] $apps The apps associated with the distribution group
     *
     * @return $this
     */
