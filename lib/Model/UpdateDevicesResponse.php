...
/**
 * UpdateDevicesResponse Class Doc Comment
 *
 * @category Class
 ...
 * @link     https://github.com/swagger-api/swagger-codegen
 */
class UpdateDevicesResponse implements ModelInterface, ArrayAccess
{
    ...
    /**
      ...
      * @var string
      */
    protected static $swaggerModelName = 'UpdateDevicesResponse';
     ...
     * Sets status_url
     *
     * @param string $status_url URL that can be used to check the status of the update devices operation.
     *
     * @return $this
     */
