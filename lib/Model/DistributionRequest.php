...
class DistributionRequest implements ModelInterface, ArrayAccess
{
    ...
    protected static $swaggerTypes = [
        'destinations' => '\Swagger\Client\Model\V01appsownerNameappNamebuildsbuildIddistributeDestinations[]',
     ...
     * Gets destinations
     *
     * @return \Swagger\Client\Model\V01appsownerNameappNamebuildsbuildIddistributeDestinations[]
     */
     ...
     * Sets destinations
     *
     * @param \Swagger\Client\Model\V01appsownerNameappNamebuildsbuildIddistributeDestinations[] $destinations Array of objects {id:string, type:string} with \"id\" being the distribution group ID, store ID, or tester email, and \"type\" being \"group\", \"store\", or \"tester\"
     *
     * @return $this
     */
