 ...
 * @link     https://github.com/swagger-api/swagger-codegen
 */
class Params2 implements ModelInterface, ArrayAccess
{
    ...
    /**
      ...
      * @var string
      */
    protected static $swaggerModelName = 'params_2';
     ...
     * Sets source_version
     *
     * @param string $source_version Version to build which represents the full Git commit reference
     *
     * @return $this
     */
     ...
     * Sets debug
     *
     * @param bool $debug Run build in debug mode
     *
     * @return $this
     */
