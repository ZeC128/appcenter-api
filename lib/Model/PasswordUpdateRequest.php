...
/**
 * PasswordUpdateRequest Class Doc Comment
 *
 * @category Class
 * @package  Swagger\Client
 * @author   Swagger Codegen team
 * @link     https://github.com/swagger-api/swagger-codegen
 */
class PasswordUpdateRequest implements ModelInterface, ArrayAccess
{
    ...
    /**
      ...
      * @var string
      */
    protected static $swaggerModelName = 'PasswordUpdateRequest';
     ...
     * Sets new_password
     *
     * @param string $new_password The new password that will be set for the user. Needs to be at least 8 characters long and contain at least one lower- and one uppercase letter.
     *
     * @return $this
     */
     ...
     * Sets old_password
     *
     * @param string $old_password The old password, if needed.
     *
     * @return $this
     */
