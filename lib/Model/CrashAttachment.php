...
/**
 * CrashAttachment Class Doc Comment
 *
 * @category Class
 * @package  Swagger\Client
 * @author   Swagger Codegen team
 * @link     https://github.com/swagger-api/swagger-codegen
 */
class CrashAttachment implements ModelInterface, ArrayAccess
{
    ...
    /**
      ...
      * @var string
      */
    protected static $swaggerModelName = 'CrashAttachment';
    ...
    public function listInvalidProperties()
    {
        ...
        if ($this->container['blob_location'] === null) {
            $invalidProperties[] = "'blob_location' can't be null";
        }
