...
/**
 * PostCreateReleaseUploadRequest Class Doc Comment
 *
 * @category Class
 * @package  Swagger\Client
 * @author   Swagger Codegen team
 * @link     https://github.com/swagger-api/swagger-codegen
 */
class PostCreateReleaseUploadRequest implements ModelInterface, ArrayAccess
{
    ...
    /**
      ...
      * @var string
      */
    protected static $swaggerModelName = 'PostCreateReleaseUploadRequest';
     ...
     * Sets build_version
     *
     * @param string $build_version User defined build version
     *
     * @return $this
     */
     ...
     * Sets build_number
     *
     * @param string $build_number User defined build number
     *
     * @return $this
     */
