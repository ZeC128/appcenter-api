...
/**
 * GrantAdminRoleRequest Class Doc Comment
 *
 * @category Class
 * @package  Swagger\Client
 * @author   Swagger Codegen team
 * @link     https://github.com/swagger-api/swagger-codegen
 */
class GrantAdminRoleRequest implements ModelInterface, ArrayAccess
{
    ...
    /**
      ...
      * @var string
      */
    protected static $swaggerModelName = 'GrantAdminRoleRequest';
    ...
    public function listInvalidProperties()
    {
        ...
        if ($this->container['admin_role'] === null) {
            $invalidProperties[] = "'admin_role' can't be null";
        }
    ...
    {
        $allowedValues = $this->getAdminRoleAllowableValues();
        if (!in_array($admin_role, $allowedValues, true)) {
