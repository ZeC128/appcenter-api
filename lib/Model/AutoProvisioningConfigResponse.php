...
/**
 * AutoProvisioningConfigResponse Class Doc Comment
 *
 * @category Class
 ...
 * @link     https://github.com/swagger-api/swagger-codegen
 */
class AutoProvisioningConfigResponse implements ModelInterface, ArrayAccess
{
    ...
    /**
      ...
      * @var string
      */
    protected static $swaggerModelName = 'AutoProvisioningConfigResponse';
     ...
     * Sets id
     *
     * @param float $id The identifier of the config.
     *
     * @return $this
     */
     ...
     * Sets app_id
     *
     * @param string $app_id The identifier of the App.
     *
     * @return $this
     */
     ...
     * Sets destination_id
     *
     * @param string $destination_id The identifier of the destination.
     *
     * @return $this
     */
     ...
     *
     * @param string $apple_distribution_certificate_key A key to a secret in customer-credential-store. distribution_certificate refers to the cusomer's certificate (that holds the private key) that will be used to sign the app.
     *
     * @return $this
     */
