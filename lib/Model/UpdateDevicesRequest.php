...
class UpdateDevicesRequest implements ModelInterface, ArrayAccess
{
    ...
    protected static $swaggerTypes = [
        ...
        'devices' => 'string[]',
        'destinations' => '\Swagger\Client\Model\UpdateDevicesRequestDestinations[]'
    ];
     ...
     * Gets destinations
     *
     * @return \Swagger\Client\Model\UpdateDevicesRequestDestinations[]
     */
     ...
     * Sets destinations
     *
     * @param \Swagger\Client\Model\UpdateDevicesRequestDestinations[] $destinations Array of distribution groups that the devices should be provisioned from.
     *
     * @return $this
     */
