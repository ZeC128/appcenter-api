...
/**
 * UserInvitationPermissionsUpdateRequest Class Doc Comment
 *
 * @category Class
 * @package  Swagger\Client
 * @author   Swagger Codegen team
 * @link     https://github.com/swagger-api/swagger-codegen
 */
class UserInvitationPermissionsUpdateRequest implements ModelInterface, ArrayAccess
{
    ...
    /**
      ...
      * @var string
      */
    protected static $swaggerModelName = 'UserInvitationPermissionsUpdateRequest';
     ...
     * Sets permissions
     *
     * @param string[] $permissions The permissions the user has for the app in the invitation
     *
     * @return $this
     */
