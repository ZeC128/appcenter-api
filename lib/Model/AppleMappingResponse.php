...
/**
 * AppleMappingResponse Class Doc Comment
 *
 * @category Class
 ...
 * @link     https://github.com/swagger-api/swagger-codegen
 */
class AppleMappingResponse implements ModelInterface, ArrayAccess
{
    ...
    /**
      ...
      * @var string
      */
    protected static $swaggerModelName = 'AppleMappingResponse';
     ...
     * Sets app_id
     *
     * @param string $app_id ID of the apple application in Mobile Center
     *
     * @return $this
     */
     ...
     * Sets apple_id
     *
     * @param string $apple_id ID of the apple application in apple store
     *
     * @return $this
     */
