...
/**
 * AddAppTesterResponse Class Doc Comment
 *
 * @category Class
 * @package  Swagger\Client
 * @author   Swagger Codegen team
 * @link     https://github.com/swagger-api/swagger-codegen
 */
class AddAppTesterResponse implements ModelInterface, ArrayAccess
{
    ...
    /**
      ...
      * @var string
      */
    protected static $swaggerModelName = 'AddAppTesterResponse';
     ...
     * Sets user_id
     *
     * @param string $user_id The user ID of the tester that needs to be added
     *
     * @return $this
     */
     ...
     * Sets release_id
     *
     * @param int $release_id The ID of the release the user was added to
     *
     * @return $this
     */
