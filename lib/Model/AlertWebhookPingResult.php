...
/**
 * AlertWebhookPingResult Class Doc Comment
 *
 * @category Class
 ...
 * @link     https://github.com/swagger-api/swagger-codegen
 */
class AlertWebhookPingResult implements ModelInterface, ArrayAccess
{
    ...
    /**
      ...
      * @var string
      */
    protected static $swaggerModelName = 'AlertWebhookPingResult';
     ...
     *
     * @param int $response_status_code HTTP status code returned in response from calling webhook
     *
     * @return $this
     */
     ...
     *
     * @param string $response_reason Reason returned in response from calling webhook
     *
     * @return $this
     */
