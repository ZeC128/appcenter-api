...
/**
 * V2SymbolUpdateInfoArrayInner Class Doc Comment
 *
 * @category Class
 ...
 * @link     https://github.com/swagger-api/swagger-codegen
 */
class V2SymbolUpdateInfoArrayInner implements ModelInterface, ArrayAccess
{
    ...
    /**
      ...
      * @var string
      */
    protected static $swaggerModelName = 'v2SymbolUpdateInfoArray_inner';
     ...
     * Sets symbol_id
     *
     * @param string $symbol_id UUID of the symbol
     *
     * @return $this
     */
     ...
     * Sets status
     *
     * @param string $status symbol upload status
     *
     * @return $this
     */
