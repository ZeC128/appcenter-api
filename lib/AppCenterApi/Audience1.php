 ...
 * @link     https://github.com/swagger-api/swagger-codegen
 */
class Audience1 implements ModelInterface, ArrayAccess
{
    ...
    /**
      ...
      * @var string
      */
    protected static $swaggerModelName = 'audience_1';
    ...
    public function setDescription($description)
    {
        if (!is_null($description) && (mb_strlen($description) > 128)) {
            throw new \InvalidArgumentException('invalid length for $description when calling Audience1., must be smaller than or equal to 128.');
        }
    ...
    public function setDefinition($definition)
    {
        if ((mb_strlen($definition) > 2000)) {
            throw new \InvalidArgumentException('invalid length for $definition when calling Audience1., must be smaller than or equal to 2000.');
        }
