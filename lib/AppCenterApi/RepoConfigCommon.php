...
/**
 * RepoConfigCommon Class Doc Comment
 *
 * @category Class
 * @package  ZeC128\AppCenter
 * @author   Swagger Codegen team
 * @link     https://github.com/swagger-api/swagger-codegen
 */
class RepoConfigCommon implements ModelInterface, ArrayAccess
{
    ...
    /**
      ...
      * @var string
      */
    protected static $swaggerModelName = 'RepoConfigCommon';
     ...
     * Sets repo_url
     *
     * @param string $repo_url The repository's git url, must be a HTTPS URL
     *
     * @return $this
     */
     ...
     * Sets repo_id
     *
     * @param string $repo_id The repository id from the repository provider. Required for repositories connected from GitHub App and GitLab.com
     *
     * @return $this
     */
     ...
     *
     * @param string $external_user_id The external user id from the repository provider. Required for GitLab.com repositories
     *
     * @return $this
     */
     ...
     *
     * @param string $service_connection_id The id of the service connection (private). Required for GitLab self-hosted repositories
     *
     * @return $this
     */
