...
class OrganizationUserResponse implements ModelInterface, ArrayAccess
{
    ...
    public function __construct(array $data = null)
    {
        ...
        $this->container['joined_at'] = isset($data['joined_at']) ? $data['joined_at'] : null;
     ...
     * Sets joined_at
     *
     * @param string $joined_at The date when the user joined the organization
     *
     * @return $this
     */
     ...
     * Sets role
     *
     * @param string $role The role the user has within the organization
     *
     * @return $this
     */
