...
/**
 * RepoConfigPostRequest Class Doc Comment
 *
 * @category Class
 * @package  ZeC128\AppCenter
 * @author   Swagger Codegen team
 * @link     https://github.com/swagger-api/swagger-codegen
 */
class RepoConfigPostRequest implements ModelInterface, ArrayAccess
{
    ...
    /**
      ...
      * @var string
      */
    protected static $swaggerModelName = 'RepoConfigPostRequest';
     ...
     *
     * @param string $installation_id The GitHub App Installation id. Required for repositories connected from GitHub App
     *
     * @return $this
     */
