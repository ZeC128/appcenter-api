...
class TestReportSteps implements ModelInterface, ArrayAccess
{
    ...
    protected static $swaggerTypes = [
        'step_name' => 'string',
        'id' => 'string',
        'step_executions' => '\ZeC128\AppCenter\AppCenterApi\TestReportStepExecutions[]',
        'failed' => 'float',
        'skipped' => 'float',
     ...
     *
     * @return \ZeC128\AppCenter\AppCenterApi\TestReportStepExecutions[]
     */
     ...
     *
     * @param \ZeC128\AppCenter\AppCenterApi\TestReportStepExecutions[] $step_executions step_executions
     *
     * @return $this
     */
