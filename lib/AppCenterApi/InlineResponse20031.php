...
class InlineResponse20031 implements ModelInterface, ArrayAccess
{
    ...
    protected static $swaggerTypes = [
        ...
        'app_id' => 'string',
        'user' => '\ZeC128\AppCenter\AppCenterApi\V01appsownerNameappNamesymbolUploadsUser',
        'status' => 'string',
        'symbol_type' => 'string',
        'symbols_uploaded' => '\ZeC128\AppCenter\AppCenterApi\V01appsownerNameappNamesymbolUploadsSymbolsUploaded[]',
        'origin' => 'string',
        'file_name' => 'string',
        'file_size' => 'float',
        'timestamp' => '\DateTime'
     ...
     * Gets user
     *
     * @return \ZeC128\AppCenter\AppCenterApi\V01appsownerNameappNamesymbolUploadsUser
     */
     ...
     * Sets user
     *
     * @param \ZeC128\AppCenter\AppCenterApi\V01appsownerNameappNamesymbolUploadsUser $user user
     *
     * @return $this
     */
     ...
     *
     * @return \ZeC128\AppCenter\AppCenterApi\V01appsownerNameappNamesymbolUploadsSymbolsUploaded[]
     */
     ...
     *
     * @param \ZeC128\AppCenter\AppCenterApi\V01appsownerNameappNamesymbolUploadsSymbolsUploaded[] $symbols_uploaded The symbols found in the upload. This may be empty until the status is indexed
     *
     * @return $this
     */
