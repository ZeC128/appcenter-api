...
/**
 * JavaScriptToolsetJavascriptSolutions Class Doc Comment
 *
 * @category Class
 * @package  ZeC128\AppCenter
 * @author   Swagger Codegen team
 * @link     https://github.com/swagger-api/swagger-codegen
 */
class JavaScriptToolsetJavascriptSolutions implements ModelInterface, ArrayAccess
{
    ...
    /**
      ...
      * @var string
      */
    protected static $swaggerModelName = 'JavaScriptToolset_javascriptSolutions';
    ...
    public function listInvalidProperties()
    {
        ...
        if ($this->container['package_json_path'] === null) {
            $invalidProperties[] = "'package_json_path' can't be null";
        }
     ...
     *
     * @param string $package_json_path The path to the detected package.json
     *
     * @return $this
     */
