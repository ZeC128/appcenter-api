...
/**
 * TeamAppUpdateRequest Class Doc Comment
 *
 * @category Class
 * @package  ZeC128\AppCenter
 * @author   Swagger Codegen team
 * @link     https://github.com/swagger-api/swagger-codegen
 */
class TeamAppUpdateRequest implements ModelInterface, ArrayAccess
{
    ...
    /**
      ...
      * @var string
      */
    protected static $swaggerModelName = 'TeamAppUpdateRequest';
     ...
     * Sets permissions
     *
     * @param string[] $permissions The permissions all members of the team have on the app
     *
     * @return $this
     */
