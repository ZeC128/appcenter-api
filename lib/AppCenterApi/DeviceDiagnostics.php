...
/**
 * DeviceDiagnostics Class Doc Comment
 *
 * @category Class
 ...
 * @link     https://github.com/swagger-api/swagger-codegen
 */
class DeviceDiagnostics implements ModelInterface, ArrayAccess
{
    ...
    /**
      ...
      * @var string
      */
    protected static $swaggerModelName = 'Device_Diagnostics';
    ...
    public function setTimeZoneOffset($time_zone_offset)
    {
        ...
        if (($time_zone_offset > 840)) {
            throw new \InvalidArgumentException('invalid value for $time_zone_offset when calling DeviceDiagnostics., must be smaller than or equal to 840.');
        }
        if (($time_zone_offset < -840)) {
            throw new \InvalidArgumentException('invalid value for $time_zone_offset when calling DeviceDiagnostics., must be bigger than or equal to -840.');
        }
