...
/**
 * AppGroupResponse Class Doc Comment
 *
 * @category Class
 * @package  ZeC128\AppCenter
 * @author   Swagger Codegen team
 * @link     https://github.com/swagger-api/swagger-codegen
 */
class AppGroupResponse implements ModelInterface, ArrayAccess
{
    ...
    /**
      ...
      * @var string
      */
    protected static $swaggerModelName = 'AppGroupResponse';
     ...
     * Sets group_id
     *
     * @param string $group_id The unique ID (UUID) of the group that the app belongs to
     *
     * @return $this
     */
