...
class Deployment implements ModelInterface, ArrayAccess
{
    ...
    public function setName($name)
    {
        if ((mb_strlen($name) > 1000)) {
            throw new \InvalidArgumentException('invalid length for $name when calling Deployment., must be smaller than or equal to 1000.');
        }
        if ((mb_strlen($name) < 1)) {
            throw new \InvalidArgumentException('invalid length for $name when calling Deployment., must be bigger than or equal to 1.');
        }
