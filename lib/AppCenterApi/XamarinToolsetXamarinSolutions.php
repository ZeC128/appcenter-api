...
/**
 * XamarinToolsetXamarinSolutions Class Doc Comment
 *
 * @category Class
 * @package  ZeC128\AppCenter
 * @author   Swagger Codegen team
 * @link     https://github.com/swagger-api/swagger-codegen
 */
class XamarinToolsetXamarinSolutions implements ModelInterface, ArrayAccess
{
    ...
    /**
      ...
      * @var string
      */
    protected static $swaggerModelName = 'XamarinToolset_xamarinSolutions';
     ...
     * Sets path
     *
     * @param string $path Path to solution
     *
     * @return $this
     */
     ...
     * Sets configurations
     *
     * @param string[] $configurations Solution configurations
     *
     * @return $this
     */
     ...
     *
     * @param string $default_configuration Solution default configuration
     *
     * @return $this
     */
