...
/**
 * CodePushStatusMetricMetadata Class Doc Comment
 *
 * @category Class
 * @package  ZeC128\AppCenter
 * @author   Swagger Codegen team
 * @link     https://github.com/swagger-api/swagger-codegen
 */
class CodePushStatusMetricMetadata implements ModelInterface, ArrayAccess
{
    ...
    /**
      ...
      * @var string
      */
    protected static $swaggerModelName = 'CodePushStatusMetricMetadata';
    ...
    public function listInvalidProperties()
    {
        ...
        if ($this->container['deployment_key'] === null) {
            $invalidProperties[] = "'deployment_key' can't be null";
        }
