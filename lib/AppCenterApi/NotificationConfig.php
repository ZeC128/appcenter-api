 ...
 * @link     https://github.com/swagger-api/swagger-codegen
 */
class NotificationConfig implements ModelInterface, ArrayAccess
{
    ...
    /**
      ...
      * @var string
      */
    protected static $swaggerModelName = 'NotificationConfig';
    ...
    const TYPE_APNS_TOKEN_CONFIG = 'apns_token_config';
    const TYPE_GCM_CONFIG = 'gcm_config';
    const TYPE_WNS_CONFIG = 'wns_config';
    ...
    {
        return [
            self::TYPE_APNS_TOKEN_CONFIG,
            self::TYPE_GCM_CONFIG,
            self::TYPE_WNS_CONFIG,
        ];
    }
