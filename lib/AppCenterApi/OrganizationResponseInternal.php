...
/**
 * OrganizationResponseInternal Class Doc Comment
 *
 * @category Class
 * @package  ZeC128\AppCenter
 * @author   Swagger Codegen team
 * @link     https://github.com/swagger-api/swagger-codegen
 */
class OrganizationResponseInternal implements ModelInterface, ArrayAccess
{
    ...
    /**
      ...
      * @var string
      */
    protected static $swaggerModelName = 'OrganizationResponseInternal';
     ...
     * Sets feature_flags
     *
     * @param string[] $feature_flags The feature flags that are enabled for this organization
     *
     * @return $this
     */
