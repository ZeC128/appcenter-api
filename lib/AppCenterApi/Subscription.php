...
class Subscription implements ModelInterface, ArrayAccess
{
    ...
    protected static $swaggerTypes = [
        ...
        'ends_at' => 'string',
        'days_left' => 'float',
        'tier' => '\ZeC128\AppCenter\AppCenterApi\SubscriptionTier',
        'active' => 'bool',
        'id' => 'string'
    ];
     ...
     * Gets tier
     *
     * @return \ZeC128\AppCenter\AppCenterApi\SubscriptionTier
     */
     ...
     * Sets tier
     *
     * @param \ZeC128\AppCenter\AppCenterApi\SubscriptionTier $tier tier
     *
     * @return $this
     */
