...
/**
 * StringProperty Class Doc Comment
 *
 * @category Class
 ...
 * @link     https://github.com/swagger-api/swagger-codegen
 */
class StringProperty implements ModelInterface, ArrayAccess
{
    ...
    /**
      ...
      * @var string
      */
    protected static $swaggerModelName = 'StringProperty';
    ...
    public function setValue($value)
    {
        if (!is_null($value) && (mb_strlen($value) > 128)) {
            throw new \InvalidArgumentException('invalid length for $value when calling StringProperty., must be smaller than or equal to 128.');
        }
