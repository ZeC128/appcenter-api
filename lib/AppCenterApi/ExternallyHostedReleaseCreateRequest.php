...
/**
 * ExternallyHostedReleaseCreateRequest Class Doc Comment
 *
 * @category Class
 ...
 * @link     https://github.com/swagger-api/swagger-codegen
 */
class ExternallyHostedReleaseCreateRequest implements ModelInterface, ArrayAccess
{
    ...
    /**
      ...
      * @var string
      */
    protected static $swaggerModelName = 'ExternallyHostedReleaseCreateRequest';
     ...
     * Sets build_version
     *
     * @param string $build_version The build version of the uploaded binary
     *
     * @return $this
     */
     ...
     * Sets build_number
     *
     * @param string $build_number The build number of the uploaded binary
     *
     * @return $this
     */
