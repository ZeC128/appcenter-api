...
/**
 * StringPropertyDiagnostics Class Doc Comment
 *
 * @category Class
 ...
 * @link     https://github.com/swagger-api/swagger-codegen
 */
class StringPropertyDiagnostics implements ModelInterface, ArrayAccess
{
    ...
    /**
      ...
      * @var string
      */
    protected static $swaggerModelName = 'StringProperty_Diagnostics';
    ...
    public function setValue($value)
    {
        if (!is_null($value) && (mb_strlen($value) > 128)) {
            throw new \InvalidArgumentException('invalid length for $value when calling StringPropertyDiagnostics., must be smaller than or equal to 128.');
        }
