...
class AccountResponse implements ModelInterface, ArrayAccess
{
     ...
     * Sets id
     *
     * @param string $id The internal unique id (UUID) of the account.
     *
     * @return $this
     */
     ...
     * Sets display_name
     *
     * @param string $display_name The display name of the account
     *
     * @return $this
     */
     ...
     * Sets name
     *
     * @param string $name The slug name of the account
     *
     * @return $this
     */
     ...
     * Sets email
     *
     * @param string $email The account's email. For org that value might be empty.
     *
     * @return $this
     */
     ...
     * Sets origin
     *
     * @param string $origin The creation origin of this account
     *
     * @return $this
     */
