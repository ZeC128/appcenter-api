...
class Device implements ModelInterface, ArrayAccess
{
    ...
    public function setTimeZoneOffset($time_zone_offset)
    {
        ...
        if (($time_zone_offset > 840)) {
            throw new \InvalidArgumentException('invalid value for $time_zone_offset when calling Device., must be smaller than or equal to 840.');
        }
        if (($time_zone_offset < -840)) {
            throw new \InvalidArgumentException('invalid value for $time_zone_offset when calling Device., must be bigger than or equal to -840.');
        }
