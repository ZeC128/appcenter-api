...
/**
 * DistributionGroupUserRequest Class Doc Comment
 *
 * @category Class
 * @package  ZeC128\AppCenter
 * @author   Swagger Codegen team
 * @link     https://github.com/swagger-api/swagger-codegen
 */
class DistributionGroupUserRequest implements ModelInterface, ArrayAccess
{
    ...
    /**
      ...
      * @var string
      */
    protected static $swaggerModelName = 'DistributionGroupUserRequest';
     ...
     * Sets user_emails
     *
     * @param string[] $user_emails The list of emails of the users
     *
     * @return $this
     */
