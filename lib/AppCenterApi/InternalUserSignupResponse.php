...
/**
 * InternalUserSignupResponse Class Doc Comment
 *
 * @category Class
 * @package  ZeC128\AppCenter
 * @author   Swagger Codegen team
 * @link     https://github.com/swagger-api/swagger-codegen
 */
class InternalUserSignupResponse implements ModelInterface, ArrayAccess
{
    ...
    /**
      ...
      * @var string
      */
    protected static $swaggerModelName = 'InternalUserSignupResponse';
    ...
    const STATUS_NEEDS_VERIFICATION = 'NeedsVerification';
     ...
     *
     * @param string $external_provider The name of the external auth provider
     *
     * @return $this
     */
     ...
     *
     * @param string $external_user_id The user ID given by the external provider
     *
     * @return $this
     */
     ...
     * Sets status
     *
     * @param string $status The current status of the user record after signup
     *
     * @return $this
     */
